...
public class SqsJobSourceRetryWrapperServiceTests
{
    private static SqsJobSourceExceptionArbiterReport TransientReport() => new()
    {
    ...
    private static SqsJobSourceExceptionArbiterReport PermanentReport() => new()
    {
        AlreadyHandled = false,
        IsCritical = false,
    ...
    private static SqsJobSourceExceptionArbiterReport CriticalReport() => new()
    {
        AlreadyHandled = false,
        IsCritical = true,
        CouldBeTransient = false
    ...
    private static SqsJobSourceExceptionArbiterReport AlreadyHandledReport(bool couldBeTransient) => new()
    {
        AlreadyHandled = true,
        IsCritical = false,
