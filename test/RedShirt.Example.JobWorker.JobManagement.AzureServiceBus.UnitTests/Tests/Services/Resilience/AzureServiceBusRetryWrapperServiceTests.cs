...
public class AzureServiceBusRetryWrapperServiceTests
{
    private static AzureServiceBusExceptionArbiterReport TransientReport()
    {
    ...
    private static AzureServiceBusExceptionArbiterReport PermanentReport()
    {
        return new AzureServiceBusExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static AzureServiceBusExceptionArbiterReport CriticalReport()
    {
        return new AzureServiceBusExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static AzureServiceBusExceptionArbiterReport AlreadyHandledReport(bool couldBeTransient)
    {
        return new AzureServiceBusExceptionArbiterReport
        {
            AlreadyHandled = true,
    ...
    {
        var arbiter = new Mock<IAzureServiceBusExceptionArbiterService>(MockBehavior.Strict);
        var sleep = CreateSleepService();
        var wrapper = new AzureServiceBusRetryWrapperService(arbiter.Object,
            NullLogger<AzureServiceBusRetryWrapperService>.Instance,
            sleep.Object);
        var ran = false;
