...
public class LoaderHandlerTests
{
    [Theory]
    [InlineData(0, 1, true)]
    [InlineData(1, 1, true)]
    ...
    public async Task TestRunAsync(int numberOfExecutorThreads, int expectedNumberOfThreads, bool wantMaintainer)
    {
        ...
        var executor = new Mock<IExecutor>(MockBehavior.Strict);
        ...
        var handler = new LoaderHandler(jobSource.Object, jobLoader.Object, maintainer.Object, executor.Object,
