...
public class AzureQueueStorageRetryWrapperServiceTests
{
    private static AzureQueueStorageExceptionArbiterReport TransientReport()
    {
    ...
    private static AzureQueueStorageExceptionArbiterReport PermanentReport()
    {
        return new AzureQueueStorageExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static AzureQueueStorageExceptionArbiterReport CriticalReport()
    {
        return new AzureQueueStorageExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static AzureQueueStorageExceptionArbiterReport AlreadyHandledReport(bool couldBeTransient)
    {
        return new AzureQueueStorageExceptionArbiterReport
        {
            AlreadyHandled = true,
    ...
    {
        var arbiter = new Mock<IAzureQueueStorageExceptionArbiterService>(MockBehavior.Strict);
        var sleep = CreateSleepService();
        var wrapper = new AzureQueueStorageRetryWrapperService(arbiter.Object,
            NullLogger<AzureQueueStorageRetryWrapperService>.Instance,
            sleep.Object);
        var ran = false;
