...
public class RabbitMqRetryWrapperServiceTests
{
    private static RabbitMqExceptionArbiterReport TransientReport()
    {
    ...
    private static RabbitMqExceptionArbiterReport PermanentReport()
    {
        return new RabbitMqExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static RabbitMqExceptionArbiterReport CriticalReport()
    {
        return new RabbitMqExceptionArbiterReport
        {
            AlreadyHandled = false,
    ...
    private static RabbitMqExceptionArbiterReport AlreadyHandledReport(bool couldBeTransient)
    {
        return new RabbitMqExceptionArbiterReport
        {
            AlreadyHandled = true,
