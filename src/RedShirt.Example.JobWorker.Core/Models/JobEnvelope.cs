...
public interface IJobEnvelope
{
    ...
    /// <summary>
    /// Raw job model. It is expected that the implementation of IJobSource could require information in custom fields on the specific implementation of IRawJobDataModel  
    /// </summary>
    IRawJobDataModel Data { get; init; }
}

public class JobEnvelope : IJobEnvelope
{
    public required IJobModel JobModel { get; init; }
    public required IRawJobDataModel Data { get; init; }
}