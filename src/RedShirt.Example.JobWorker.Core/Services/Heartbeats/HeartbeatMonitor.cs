...
/// <summary>
///     The monitor is responsible for making sure that messages checked out from the job source remain 'in flight'.
/// </summary>
internal interface IHeartbeatMonitor : IHandlerSubComponent;
...
#pragma warning restore S107
{
    ...
    ///     The heartbeat monitor loop uses this to round values up to 500ms to avoid possible inching
    ...
    ///     In local testing, had a situation where the HeartbeatMonitor slept for 00:00:00.0013576,
