...
namespace RedShirt.Example.JobWorker.JobManagement.AzureKeyVault.Clients;
...
public class AzureKeyVaultClientWrapper(SecretClient secretClient) : IAzureKeyVaultClientWrapper
{
